...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python evaluation/dummy_cleansing.py\n"
            "  python evaluation/dummy_cleansing.py --only modelset-uml-xmi\n"
            "  python evaluation/dummy_cleansing.py --evaluation-dir evaluation-runs\n"
        ),
    )
    parser.add_argument(
        "--only",
