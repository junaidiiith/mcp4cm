...
class ModelParseDiagnostics:
    ...
    def to_model_diagnostics(self) -> ModelDiagnostics:
        """Convert parser-internal diagnostics into the core diagnostics shape."""
        return ModelDiagnostics(
            ...
            parse_time_ms=int(self.parse_time_ms),
            source_path=str(self.relpath),
        )
